...
* Let `mount` know to start the database connection by `require`-ing plog.db.core in some other namespace.
...
Request middleware functions are located under the `plog.middleware` namespace.

This namespace is reserved for any custom middleware for the application. Some default middleware is
already defined here. The middleware is assembled in the `wrap-base` function.

Middleware used for development is placed in the `plog.dev-middleware` namespace found in
